...
const relativeDensityMilk = 1.020 // kg/l

function calculateMicrowaveTime(volume=220, watt=800, initialTemperature=7, targetTemperature=45) {
...
submitButton.addEventListener("click", event => {
  ...
  result.textContent = calculateMicrowaveTime(volume.value)
})
